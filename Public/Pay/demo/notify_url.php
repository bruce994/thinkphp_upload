...
$dbconfig = require_once dirname(__FILE__).'/../../../config/config.php';
...
$db = new db_mysql();
$db->halt = $cfg['sqlerr'];
$db->connect($BJCMS_CONFIG['db']['host'], $BJCMS_CONFIG['db']['username'], $BJCMS_CONFIG['db']['password'], $BJCMS_CONFIG['db']['database'],0);
